...
## MS data files in CDF format

Example MS data files in (AIA/ANDI) NetCDF format. Data from the article from 
Saghatelian et al. (*Assignment of endogenous substrates to enzymes by global 
metabolite profiling*, Biochemistry, 2004) 
[doi](http://dx.doi.org/10.1021/bi0480335) representing LC-MS measurement from 6
FAAH knock-out and 5 wild type mice acquired in positive ionization mode. The
data is subset to an *m/z* range of 200-600 and a retention time range from
2500-4500 seconds. The available data files are:
